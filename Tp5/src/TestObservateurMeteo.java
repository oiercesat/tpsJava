 ...
 * @date jj/mm/aa
 **/
public class TestObservateurMeteo {
	// CONSTANTES 				-non-
	// ATTRIBUTS 				-non-
	// CONSTRUCTEURS 			-non-
    ...
    public static void main(String[] args) {
    	...
    	while (true) {
	    	...
	    	sondeMeteo.setValeursObservees(dateHeureSaisie, temperatureSaisie, pressionSaisie);
	    	...
	    	System.out.println ("\n# Le programme principal affiche (cf. toString) l'observateur : " + afficheur.getObservableMeteo().getLibelle());
	    	System.out.println (afficheur.toString());

	    	System.out.println ("\n# Le programme principal affiche (cf. toString) l'observateur : " + baseDeDonnees.getObservableMeteo().getLibelle());
